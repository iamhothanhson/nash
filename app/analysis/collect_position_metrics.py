...
def save_entry_snapshot(snapshot: EntrySnapshot) -> None:
    ...
    existing.append({
        ...
        "market_state": {
            ...
            "regime_confidence": snapshot.market_state.regime_confidence,
        ...
        "indicators": {
            "ema_slope_15m": snapshot.indicators.ema_slope_15m,
            "ema_slope_1h": snapshot.indicators.ema_slope_1h,
            "adx_15m": snapshot.indicators.adx_15m,
            "adx_1h": snapshot.indicators.adx_1h,
            "atr_percent": snapshot.indicators.atr_percent,
            "atr_percentile": snapshot.indicators.atr_percentile,
            "rsi": snapshot.indicators.rsi,
            "volume_ratio": snapshot.indicators.volume_ratio,
        },
        "setup_features": {
            "setup_score": snapshot.setup_features.setup_score,
            "confirmation_mode": snapshot.setup_features.confirmation_mode,
            "breakout_strength_pct": snapshot.setup_features.breakout_strength_pct,
            "distance_from_level_pct": snapshot.setup_features.distance_from_level_pct,
            "candle_body_ratio": snapshot.setup_features.candle_body_ratio,
            "wick_ratio": snapshot.setup_features.wick_ratio,
