...
from backtesting.debug import PrintDebug
from backtesting.utils import print_result
from core.debug import BREAKOUT_PIPELINE_DEBUG, BREAKOUT_REJECTION_DEBUG, MARKET_STRUCTURE_DEBUG
...
def main() -> None:
    ...
    if BREAKOUT_REJECTION_DEBUG:
        PrintDebug.print_breakout_rejection(result)
    if BREAKOUT_PIPELINE_DEBUG:
        PrintDebug.print_breakout_pipeline(result)
